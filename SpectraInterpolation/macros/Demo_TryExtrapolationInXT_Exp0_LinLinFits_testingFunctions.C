...
void Demo_TryExtrapolationInXT_Exp0_LinLinFits_testingFunctions(Bool_t xt=kTRUE, Float_t expo=0.)
{
        SetStyle();
        gStyle->SetOptFile(0);
        gStyle->SetOptStat(0);
...
//	TGraphErrors* ratio_cdf_630_g = divide_graph_by_function(cdf_630_g,merge_fit);
	...
	for(Int_t ipt=0; ipt<=11; ipt++) {
		...
		fitXS[ipt] = new TF1(Form("fitXS%d",ipt),"exp([0]+[1]*log(x)+[2]*log(x)*log(x))",0.3,7.2);
//		fitXS[ipt] = new TF1(Form("fitXS%d",ipt),"pol2",0.3,7.2);
//		fitXS[ipt] = new TF1(Form("fitXS%d",ipt),"[0]*(1.+[1]/x)^[2]",0.3,7.2);
//                fitXS[ipt]->SetParameters(1.,1e-6,-1.);
//                fitXS[ipt]->SetParameters(1.34252e-02,4.63236e-02,-4.69843e+00);
//                fitXS[ipt]->SetParameters(9.89692e-17,3.39284e+01,5.07925e+00);
//                fitXS[ipt]->SetParameters(1e-4,-1e-5,-1e-8);
//                fitXS[ipt]->FixParameter(0,1e-4);
//                fitXS[ipt]->FixParameter(1,-1e-5);
//                fitXS[ipt]->FixParameter(2,-1e-8);
//	 	gXS[ipt]->Fit(fitXS[ipt], "REM0"); //"REMW");
                std::cerr<<" STARTS " << std::endl;
	 	gXS[ipt]->Fit(fitXS[ipt], "R0"); //"REMW");
	 	gXS[ipt]->Fit(fitXS[ipt], "R0"); //"REMW");

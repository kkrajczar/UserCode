...
void CombineSpectra_FullTrackTrigger_Track20_EtaCM_M03_M08_NoOLDAlignmentRuns()
{
   ...
   bool doSave = false;
   TFile * f_output = new TFile("CombineSpectra_FullTrackTrigger_Track20_EtaCM_M03_M08_NoOLDAlignmentRuns.root","recreate");

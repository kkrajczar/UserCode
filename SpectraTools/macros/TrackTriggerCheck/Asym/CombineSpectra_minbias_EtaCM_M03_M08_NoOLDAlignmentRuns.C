...
void CombineSpectra_minbias_EtaCM_M03_M08_NoOLDAlignmentRuns()
{
   ...
   bool doSave = true;
   TFile * f_output = new TFile("CombineSpectra_minbias_EtaCM_M03_M08_NoOLDAlignmentRuns.root","recreate");

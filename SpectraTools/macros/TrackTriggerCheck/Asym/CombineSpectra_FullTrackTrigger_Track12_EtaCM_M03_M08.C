...
void CombineSpectra_FullTrackTrigger_Track12_EtaCM_M03_M08()
{
   ...
   bool doSave = false;
   TFile * f_output = new TFile("CombineSpectra_FullTrackTrigger_Track12_EtaCM_M03_M08.root","recreate");

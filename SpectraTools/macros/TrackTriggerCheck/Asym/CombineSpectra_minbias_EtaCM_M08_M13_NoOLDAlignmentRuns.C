...
void CombineSpectra_minbias_EtaCM_M08_M13_NoOLDAlignmentRuns()
{
   ...
   bool doSave = true;
   TFile * f_output = new TFile("CombineSpectra_minbias_EtaCM_M08_M13_NoOLDAlignmentRuns.root","recreate");

...
void CombineSpectra_minbias_EtaCM_P13_P18_NoOLDAlignmentRuns()
{
   ...
   bool doSave = true;
   TFile * f_output = new TFile("CombineSpectra_minbias_EtaCM_P13_P18_NoOLDAlignmentRuns.root","recreate");

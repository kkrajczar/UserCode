...
void CombineSpectra_FullTrackTrigger_Track30_Track50_EtaCM_P08_P13()
{
   ...
   bool doSave = false;
   TFile * f_output = new TFile("CombineSpectra_FullTrackTrigger_Track30_Track50_EtaCM_P08_P13.root","recreate");

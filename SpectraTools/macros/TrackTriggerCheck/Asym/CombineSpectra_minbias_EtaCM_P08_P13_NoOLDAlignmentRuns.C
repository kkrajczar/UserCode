...
void CombineSpectra_minbias_EtaCM_P08_P13_NoOLDAlignmentRuns()
{
   ...
   bool doSave = true;
   TFile * f_output = new TFile("CombineSpectra_minbias_EtaCM_P08_P13_NoOLDAlignmentRuns.root","recreate");

...
void CombineSpectra_FullTrackTrigger_Track12_EtaCM_P03_P08_NoOLDAlignmentRuns()
{
   ...
   bool doSave = false;
   TFile * f_output = new TFile("CombineSpectra_FullTrackTrigger_Track12_EtaCM_P03_P08_NoOLDAlignmentRuns.root","recreate");

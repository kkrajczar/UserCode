...
void CombineSpectra_FullTrackTrigger_Track12_EtaCM_M08_M13()
{
   ...
   bool doSave = false;
   TFile * f_output = new TFile("CombineSpectra_FullTrackTrigger_Track12_EtaCM_M08_M13.root","recreate");

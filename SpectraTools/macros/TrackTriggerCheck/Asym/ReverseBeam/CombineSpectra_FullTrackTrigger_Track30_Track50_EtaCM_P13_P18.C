...
void CombineSpectra_FullTrackTrigger_Track30_Track50_EtaCM_P13_P18()
{
   ...
   bool doSave = false;
   TFile * f_output = new TFile("CombineSpectra_FullTrackTrigger_Track30_Track50_EtaCM_P13_P18.root","recreate");

...
void PtSpectraCombination_StagedNormalization_EtaCM_M13_M18()
{
   gROOT->Reset();
...
//   gStyle->SetPadRightMargin(0.16);
   ...
   TFile *f_minbias = new TFile("CombineSpectra_minbias_EtaCM_M13_M18.root");
   TFile *f_FullTrack_12 = new TFile("CombineSpectra_FullTrackTrigger_Track12_EtaCM_M13_M18.root");
   TFile *f_FullTrack_20 = new TFile("CombineSpectra_FullTrackTrigger_Track20_EtaCM_M13_M18.root");
   TFile *f_FullTrack_30_50 = new TFile("CombineSpectra_FullTrackTrigger_Track30_Track50_EtaCM_M13_M18.root");
   TFile *f_out = new TFile("PtSpectraCombination_StagedNormalization_EtaCM_M13_M18_TrackTrigger.root","recreate");
...
//   hPartPt_32_X_FullTrack30_corrected->SetFillStyle(3002);
   ...
   leg1->Draw();
   if(doSave) {
      c1->SaveAs("Figs/PtSpectraCombination_StagedNormalization_EtaCM_M13_M18_c1.gif");
      c1->SaveAs("Figs/PtSpectraCombination_StagedNormalization_EtaCM_M13_M18_c1.eps");
      c1->SaveAs("Figs/PtSpectraCombination_StagedNormalization_EtaCM_M13_M18_c1.C");
   }
   ...
   if(doSave) {
      c2->SaveAs("Figs/PtSpectraCombination_StagedNormalization_EtaCM_M13_M18_c2.gif");
      c2->SaveAs("Figs/PtSpectraCombination_StagedNormalization_EtaCM_M13_M18_c2.eps");
      c2->SaveAs("Figs/PtSpectraCombination_StagedNormalization_EtaCM_M13_M18_c2.C");
   }

...
void CombineSpectra_FullTrackTrigger_Track20_EtaCM_P03_P08()
{
   ...
   bool doSave = false;
   TFile * f_output = new TFile("CombineSpectra_FullTrackTrigger_Track20_EtaCM_P03_P08.root","recreate");

...
void CombineSpectra_FullTrackTrigger_Track30_Track50_EtaCM_M13_M18()
{
   ...
   bool doSave = false;
   TFile * f_output = new TFile("CombineSpectra_FullTrackTrigger_Track30_Track50_EtaCM_M13_M18.root","recreate");

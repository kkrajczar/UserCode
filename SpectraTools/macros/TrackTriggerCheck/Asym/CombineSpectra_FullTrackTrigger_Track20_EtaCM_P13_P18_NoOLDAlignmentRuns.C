...
void CombineSpectra_FullTrackTrigger_Track20_EtaCM_P13_P18_NoOLDAlignmentRuns()
{
   ...
   bool doSave = false;
   TFile * f_output = new TFile("CombineSpectra_FullTrackTrigger_Track20_EtaCM_P13_P18_NoOLDAlignmentRuns.root","recreate");

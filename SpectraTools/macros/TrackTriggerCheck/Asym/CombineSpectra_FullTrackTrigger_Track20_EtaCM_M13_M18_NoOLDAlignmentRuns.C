...
void CombineSpectra_FullTrackTrigger_Track20_EtaCM_M13_M18_NoOLDAlignmentRuns()
{
   ...
   bool doSave = false;
   TFile * f_output = new TFile("CombineSpectra_FullTrackTrigger_Track20_EtaCM_M13_M18_NoOLDAlignmentRuns.root","recreate");

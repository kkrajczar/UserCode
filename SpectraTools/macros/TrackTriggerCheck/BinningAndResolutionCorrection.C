...
//   gStyle->SetPadRightMargin(0.16);
   ...
   TFile *f_output = new TFile("BinningAndResolutionCorrection_TrackTrigger.root","recreate");
   TFile *f_input = new TFile("PtSpectraCombination_StagedNormalization_TrackTrigger.root");
...
//   hPt->Fit(fitTot,"RI+","same");
   ...
   leg2->AddEntry(fFit4,"p_{T}: 25 - 207 GeV/c","l");

...
void CombineSpectra_FullTrackTrigger_Track12_NoOLDAlignmentRuns()
{
   ...
   bool doSave = false;
   TFile * f_output = new TFile("CombineSpectra_FullTrackTrigger_Track12_NoOLDAlignmentRuns.root","recreate");

// $Id: HIChargedMultiplicityAnalyzer_new.cc,v 1.1 2010/10/29 15:27:49 krajczar Exp $
// TRICK: DataContainer in the recHit loops

#include "HIChargedMultiplicityAnalyzer_new.h"

/*****************************************************************************/
HIChargedMultiplicityAnalyzer_new::HIChargedMultiplicityAnalyzer_new(const edm::ParameterSet& pset)
{
...
/*****************************************************************************/
HIChargedMultiplicityAnalyzer_new::~HIChargedMultiplicityAnalyzer_new()
{
}

/*****************************************************************************/
void HIChargedMultiplicityAnalyzer_new::beginJob()
{
...
/*****************************************************************************/
void HIChargedMultiplicityAnalyzer_new::endJob()
{
  TDirectory::TContext context(resultFile);
...
/*****************************************************************************/
float HIChargedMultiplicityAnalyzer_new::getVertexZ
...
/*****************************************************************************/
int HIChargedMultiplicityAnalyzer_new::getContainedHits
...
/*****************************************************************************/
float HIChargedMultiplicityAnalyzer_new::produceClusterVertex
...
/*****************************************************************************/
void HIChargedMultiplicityAnalyzer_new::clusterVertices
...
/*****************************************************************************/
bool HIChargedMultiplicityAnalyzer_new::aboveTriggerThreshold_1(edm::Handle<CaloTowerCollection> towers)
{
  int negTowers = 0;
  int posTowers = 0;
...
/*****************************************************************************/
bool HIChargedMultiplicityAnalyzer_new::aboveTriggerThreshold_2(edm::Handle<CaloTowerCollection> towers)
{
  int negTowers = 0;
  int posTowers = 0;
  for(CaloTowerCollection::const_iterator cal = towers->begin(); cal != towers->end(); ++cal) {
...
/*****************************************************************************/
bool HIChargedMultiplicityAnalyzer_new::trackTrigger(edm::Handle<reco::TrackCollection>& recCollection)
{
...
/*****************************************************************************/
bool HIChargedMultiplicityAnalyzer_new::track5Trigger(edm::Handle<reco::TrackCollection>& recCollection)
{
  int tracks = recCollection.product()->size();
  if(tracks>4)
    return true;
...
/*****************************************************************************/
bool HIChargedMultiplicityAnalyzer_new::ChristofMinBias(const edm::Event& event, const edm::EventSetup& eventSetup)
{
...
/*****************************************************************************/
bool HIChargedMultiplicityAnalyzer_new::RichardMinBias(Handle<HcalTrigPrimDigiCollection>& tpg)
{
  bool pos = false;
  bool neg = false; 
  double tpg_et = 0.;
...
/*****************************************************************************/
bool HIChargedMultiplicityAnalyzer_new::isRecHitAtTheEdge(SiPixelRecHitCollection::DataContainer::const_iterator iPRH,
                                                    const PixelGeomDetUnit* pgdu)
{
...
/*****************************************************************************/
void HIChargedMultiplicityAnalyzer_new::FirstSimOnFirst(edm::Handle<SiPixelRecHitCollection>& siPixelRecCollection,
//                                                  const reco::VertexCollection* vertices,
                                                  const edm::Event& ev,
                                                  const edm::EventSetup& es)
{
//  std::cerr<<"HIChargedMultiplicityAnalyzer_new::FirstSimOnFirst(1)"<<std::endl;
...
*/
  ...
  bool isPrim = false;
//  std::cerr<<"HIChargedMultiplicityAnalyzer_new::FirstSimOnFirst(2)"<<std::endl;
  ...
  for(TrackingParticleCollection::const_iterator t = tPC->begin(); t != tPC->end(); ++t) {
     std::vector<const SiPixelRecHit*> tpRecHitVector;
        ...
        if(earliestSH->processType()==2 && layer == 1 && (pgdu->subDetector() == GeomDetEnumerators::PixelBarrel)) {  //tp_psh
           ...
           for(SiPixelRecHitCollection::DataContainer::const_iterator iPRH = pixelRecHits.data().begin(); iPRH != pixelRecHits.data().end(); ++iPRH ) {
//std::cerr<<"HIChargedMultiplicityAnalyzer_new::FirstSimOnFirst(3)"<<std::endl;
            std::vector<PSimHit> associatedSimHits = simHitFinder.associateHit(*iPRH);
//std::cerr<<"HIChargedMultiplicityAnalyzer_new::FirstSimOnFirst(4)"<<std::endl;
...
/*****************************************************************************/
void HIChargedMultiplicityAnalyzer_new::checkVertices
  (
//   const reco::VertexCollection* vertices,
...
/*****************************************************************************/
PSimHit* HIChargedMultiplicityAnalyzer_new::findLatestPSimHit
...
/*****************************************************************************/
PSimHit* HIChargedMultiplicityAnalyzer_new::findEarliestPSimHit
  (std::vector<PSimHit>& simHits)
{
  if(simHits.size()<1)
...
/*****************************************************************************/
bool HIChargedMultiplicityAnalyzer_new::comparePSimHits
...
/*****************************************************************************/
bool HIChargedMultiplicityAnalyzer_new::compareRecHits
...
/*****************************************************************************/
void HIChargedMultiplicityAnalyzer_new::checkEta
...
/*****************************************************************************/
void HIChargedMultiplicityAnalyzer_new::checkSimTracks
...
/*****************************************************************************/
float HIChargedMultiplicityAnalyzer_new::geomAcc(double vert_z, double eta_l, double eta_h, int desLayer)
{
...
/*****************************************************************************/
void HIChargedMultiplicityAnalyzer_new::multiplicityProperties
   (const edm::Event& ev, const edm::EventSetup& es, edm::Handle<CaloTowerCollection> towers,
    edm::Handle<SiPixelRecHitCollection> siPixelRecCollection,
//    const reco::VertexCollection* vertices,
    HepMC::GenEvent * myGenEvent,
...
//          cerr<< " [HIChargedMultiplicityAnalyzer_new]: new recHit" << endl;;
...
/*****************************************************************************/
bool HIChargedMultiplicityAnalyzer_new::isAtEdge
...
/*****************************************************************************/
vector<PSimHit> HIChargedMultiplicityAnalyzer_new::orderPSimHits(vector<PSimHit> simHits)
{
...
/*****************************************************************************/
void HIChargedMultiplicityAnalyzer_new::analyze
  (const edm::Event& ev, const edm::EventSetup& es)
{
  std::cerr<<"[HIChargedMultiplicityAnalyzer_new] started" << std::endl;
...
//  std::cerr<<"[HIChargedMultiplicityAnalyzer_new] (2)" << std::endl;

...
/*****************************************************************************/
VertexProducerClusterCounting::VertexProducerClusterCounting
...
/*****************************************************************************/
void VertexProducerClusterCounting::beginJob
  (const edm::EventSetup& es)
{
}

/*****************************************************************************/
int VertexProducerClusterCounting::getContainedHits
...
/*****************************************************************************/
void VertexProducerClusterCounting::produce

// $Id: HIChargedMultiplicityAnalyzer_new.h,v 1.2 2011/11/06 16:57:59 krajczar Exp $
...
/*****************************************************************************/
class HIChargedMultiplicityAnalyzer_new : public edm::EDAnalyzer
{
 public:
   explicit HIChargedMultiplicityAnalyzer_new(const edm::ParameterSet& pset);
   ~HIChargedMultiplicityAnalyzer_new();

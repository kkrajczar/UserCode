...
//  gStyle->SetOptStat(0);
  ...
  ntuple_mc->Project("hSizeData_mc","clustSizeX","rver_z!=0 && bit34 && isTrigger_1");
  ntuple->Project("hSizeData_sel","clustSizeX","rver_z!=0 && bit34 && isTrigger_1");

  hSizeData_mc->GetXaxis()->SetTitle("Cluster size in local x");

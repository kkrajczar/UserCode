...
// $Id: HI_simple_nosiminfo.cc,v 1.1 2011/11/06 17:08:33 krajczar Exp $
...
//      std::cerr<<"   what is it?: " <<  triggerNames.triggerName(itrig).c_str() << std::endl;
      ...
      if(strcmp(triggerNames.triggerName(itrig).c_str(),"HLT_HIMinBiasHfOrBSC") == 0)
        is_HLT_HIMinBiasHfOrBSC = true;
      ...
      if(strcmp(triggerNames.triggerName(itrig).c_str(),"HLT_HIMinBiasBSC_OR") == 0)
        is_HLT_HIMinBiasBSC_OR = true;
  ...
  result.push_back(is_HLT_HIMinBiasHfOrBSC);
  ...
  result.push_back(is_HLT_HIMinBiasBSC_OR);
...
//          result_looper.push_back(vertices->size());
          ...
          result_looper.push_back(is_HLT_HIMinBiasHfOrBSC);
          ...
          result_looper.push_back(is_HLT_HIMinBiasBSC_OR);

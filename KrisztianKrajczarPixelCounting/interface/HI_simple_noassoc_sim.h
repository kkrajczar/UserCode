// $Id: HI_simple_noassoc_sim.h,v 1.1 2011/11/06 17:00:49 krajczar Exp $
...
/*****************************************************************************/
class HI_simple_noassoc_sim : public edm::EDAnalyzer
{
 public:
   explicit HI_simple_noassoc_sim(const edm::ParameterSet& pset);
   ~HI_simple_noassoc_sim();
